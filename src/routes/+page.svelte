...
<svelte:head>
  ...
  <meta
    name="description"
    content="Backing builders of what's next. We are a venture firm that leads Pre-Seed, Seed and Series A rounds in standout software companies."
  />
</svelte:head>
...
<div class="flex w-full max-w-336 flex-col items-center gap-32 px-6 md:px-16">
    ...
    <div class="flex flex-col gap-16 md:flex-row md:items-center lg:gap-32">
      ...
      <div class="relative md:basis-1/2">
        ...
        >
          ...
          <circle
            class="circle-animation fill-violet-300"
            cx="040"
            cy="320"
            r="10"
    ...
    <div class="flex flex-col gap-16 md:flex-row-reverse md:items-center lg:gap-32">
      ...
      <div class="relative md:basis-1/2">
        ...
        >
          ...
          <circle
            class="stage-animation fill-blue-400"
            cx="200"
            cy="100"
            r="45"
          ...
          />
          <circle
            class="stage-animation fill-teal-400"
            cx="120"
            cy="200"
            r="50"
            style="animation-delay: 1.5s;"
          />
          <circle
            class="stage-animation fill-violet-400"
            cx="280"
            cy="220"
            r="40"
      ...
      <div class="relative md:basis-1/2">
        ...
        >
          <style>
            ...
            .s1 {
              animation: pulse1 5s cubic-bezier(0.42, 0, 0.58, 1) infinite;
            }
            .s2 {
              animation: pulse2 5s cubic-bezier(0.42, 0, 0.58, 1) infinite;
            }
            .s3 {
              animation: pulse3 5s cubic-bezier(0.42, 0, 0.58, 1) infinite;
            }
            @keyframes pulse1 {
              0%,
              46%,
  ...
  <div class="flex flex-col items-center gap-12">
    ...
    <div class="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
      ...
      <TeamMember
        name="Ricky Fiel"
        linkedinUrl="https://www.linkedin.com/in/rickyfiel"
      ...
      <TeamMember
        name="Genevive Fiel"
        linkedinUrl="https://www.linkedin.com/in/genevive-fiel-4822866a"
        role="Founder & Managing Partner"
